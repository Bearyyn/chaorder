...
public class SearchKSService {
  ...
  public interface Iface {
    ...
    public java.util.List<EventPayload> process(String content) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void process(String content, org.apache.thrift.async.AsyncMethodCallback<java.util.List<EventPayload>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_process(String content) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class process_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<EventPayload>> {
      ...
      public process_call(String content, org.apache.thrift.async.AsyncMethodCallback<java.util.List<EventPayload>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<EventPayload>(_list0.size);
                  EventPayload _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new EventPayload();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, process_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (EventPayload _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (EventPayload _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<EventPayload>(_list5.size);
            EventPayload _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new EventPayload();
              _elem6.read(iprot);
